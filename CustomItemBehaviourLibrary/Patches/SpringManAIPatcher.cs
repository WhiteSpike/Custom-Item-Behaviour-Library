...
namespace CustomItemBehaviourLibrary.Patches
{
    ...
    internal static class SpringManAIPatcher
    {
        ...
        {
            if (LookoutBehaviour.HasLineOfSightToPeepers(__instance.transform.position)) __instance.currentBehaviourStateIndex = 1;
        }
        [HarmonyTranspiler]
        ...
        {
            MethodInfo peeperMethod = typeof(LookoutBehaviour).GetMethod("HasLineOfSightToPeepers", BindingFlags.Public | BindingFlags.Static);
